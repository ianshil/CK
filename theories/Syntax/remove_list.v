...
Lemma in_not_touched_remove : forall l1 (a0 a1 : form),
...
Lemma remove_not_in_anymore : forall l (A : form),
...
Lemma remove_preserv_NoDup : forall l (A : form), NoDup l -> NoDup (remove eq_dec_form A l).
Proof.
induction l.
...
Lemma remove_le_length : forall l (A : form), length (remove eq_dec_form A l) <= length l.
Proof.
induction l.
...
Lemma remove_In_smaller_length : forall l (A : form),
...
Lemma In_remove_diff : forall l (A B : form), In A (remove eq_dec_form B l) -> A <> B.
Proof.
induction l ; intros.
...
Lemma In_remove_same : forall l1 l2 (A : form), In A l1 ->
...
Lemma In_remove_length_same : forall l1 l2 (A : form), In A l1 ->
...
Lemma remove_list_singl_id_or_nil : forall l (A : form), remove_list l [A] = nil \/ remove_list l [A] = [A].
Proof.
induction l.
- intros. right. auto.
...
Lemma remove_list_non_empty_inter_smaller_length : forall l2 l1 (A : form),
...
Lemma In_remove_list_In_list : forall (A : form) l1 l2, In A (remove_list l1 l2) -> In A l2.
Proof.
...
Lemma In_remove_list_In_list_not_In_remove_list : forall (A : form) l1 l2,
